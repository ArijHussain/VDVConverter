...
public class Vdv452ToGtfsConverterMain {
  ...
  public static void main(String[] args)throws IOException{
    ...
    // first param is the input VDV-452 files path, second param is the putput directory where the GTFS data will be saved
      String[] args1 = new String[]{"C:\\Users\\Arij\\Desktop\\Work\\VDV\\Data\\edited_peremailsendenbasis_ver_gueltigkeit_x10firmenkalender", "C:\\Users\\Arij\\Desktop\\Work\\VDV\\Output_GTFS"};
      m.run(args1);
  }
